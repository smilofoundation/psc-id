...
class CheckinOKPage extends React.Component {
    componentDidMount() {
    ...
    render() {
        const {registering, bookings} = this.props;
        ...
        return (
            ...
            <div className="col-md-6 col-md-offset-3">
                    <div className="klm-header-container">
                        <h1 className="klm-header">Congratulations, your biometrics is now saved into a Private Smart Contract.</h1>
                        <h3>Please proceed to the gates.</h3>
                    </div>
                    ...
                    <div className="form-group">
                        <button onClick={this.handleClick} className="btn btn-primary">Go to Gate 1 now</button>
                        {registering &&
                        <img
                            src="data:image/gif;base64,"/>
                        }
...
const connectedBookPage = connect(mapStateToProps)(CheckinOKPage);
export {connectedBookPage as CheckinOKPage};